...
export default function InvestigationsPage() {
  return (
    <div className="relative flex flex-col">
      <section className="relative min-h-[40vh] flex flex-col items-center justify-center text-center px-4 pt-24 pb-16 overflow-hidden">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-[#FF5A5A]/6 rounded-full blur-[120px] pointer-events-none" />
        <div className="relative">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#262626] text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-6">
            <AlertTriangle className="w-3.5 h-3.5 text-[#FF5A5A]" />
            Public Investigations
          </span>
          <h1 className="max-w-4xl text-4xl sm:text-5xl font-bold tracking-tight leading-tight text-white">
            AI-Generated <span className="text-[#FF5A5A]">Forensic Reports</span>
          </h1>
        ...
        <div className="flex flex-col gap-6">
          {INVESTIGATIONS.map((inv, i) => (
            <motion.div
              ...
              className="flex flex-col gap-4 p-6 rounded-2xl bg-[#111111] border border-[#1A1A1A] hover:border-[#262626] transition group"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-xs text-zinc-500 leading-relaxed">{inv.summary}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="p-3 rounded-xl bg-[#FF5A5A]/5 border border-[#FF5A5A]/15">
                  <p className="text-[10px] font-bold text-[#FF5A5A] uppercase tracking-wider mb-1">Investor Warning</p>
                  <p className="text-xs text-zinc-300 leading-relaxed">{inv.investorWarning}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 text-[10px] font-bold text-[#00E5A8] hover:gap-2 transition-all"
                >
