  ...
  return (
    <div className="relative flex flex-col">
      <section className="relative min-h-[40vh] flex flex-col items-center justify-center text-center px-4 pt-24 pb-16 overflow-hidden bg-grid-pattern">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-blue-500/6 rounded-full blur-[140px] pointer-events-none" />
        ...
        {submitted ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <div className="md:col-span-3">
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-6 rounded-2xl bg-card/80 border border-border glass-panel-hover">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">First Name</label>
                    <input required placeholder="John" className="bg-background/80 border border-input rounded-xl px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-ring transition glass" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Last Name</label>
                    <input required placeholder="Doe" className="bg-background/80 border border-input rounded-xl px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-ring transition glass" />
                  </div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Email</label>
                  <input required type="email" placeholder="john@example.com" className="bg-background/80 border border-input rounded-xl px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-ring transition glass" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Subject</label>
                  <select className="bg-background/80 border border-input rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:border-ring transition glass">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea required rows={5} placeholder="How can we help?" className="bg-background/80 border border-input rounded-xl px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-ring transition resize-none glass" />
                </div>
            ...
            <div className="md:col-span-2 flex flex-col gap-4">
              <div className="p-5 rounded-2xl bg-card/80 border border-border glass-panel-hover">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-muted border border-border flex items-center justify-center">
                   ...
                   <div>
                      ...
                      <p className="text-xs text-muted-foreground">vaibhavjj99@gmail.com</p>
                    </div>
                </div>
              </div>
              <div className="p-5 rounded-2xl bg-card/80 border border-border glass-panel-hover">
